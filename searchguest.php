        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="searchguest.html"><i class="fa fa-fw fa-file"></i> Search for a Guest</a>
                    </li>
                    <li>
			 ...
			 <div class="row">
                    ...
                    <div class="search-container">
                        <style> 
                            ...
                            <form>
                                <input type="text" name="search" placeholder="Jorge">
                            </form>
                    </div>
                    <p></p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tbody>
                                        ...
                                        <?php
                                          $select_sql= "SELECT  s.firstName, s.lastname, r.roomNumber, s.phone, s.address, s.checkinDate, s.checkoutDate
                                          FROM Rooms AS r
